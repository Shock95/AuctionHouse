...
use AuctionHouse\menu\MenuRenderer;
...
use AuctionHouse\commands\AHCommand;
use AuctionHouse\economy\EconomyProvider;
use AuctionHouse\economy\EconomySProvider;
...
class AuctionHouse extends PluginBase {
	...
	public function onLoad() {
		...
		UpdateNotifier::checkUpdate($this, "AuctionHouse", "1.0.0");
